...
rule
  ...
  rhs_sequence:
    ...
    | rhs_sequence symbol parameterized_suffix named_ref? TAG?
        {
    ...
    | rhs_sequence IDENTIFIER "(" parameterized_args ")" named_ref? TAG?
        {
    ...
    | rhs_sequence midrule_action named_ref? TAG?
        {
          user_code = val[1]
          user_code.alias_name = val[2]
          user_code.tag = val[3]
